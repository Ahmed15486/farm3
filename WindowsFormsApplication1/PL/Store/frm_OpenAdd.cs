...
namespace WindowsFormsApplication1.PL.Store
{
    public partial class frm_OpenAdd : Form
    {
        ...
        public void AddRow()
        {
            ...
            dgv.CurrentRow.Cells["CPrice"].Value = txt_CPrice.Text;
            dgv.CurrentRow.Cells["Total"].Value = Math.Round(Convert.ToDecimal(txt_Quan.Text) * Convert.ToDecimal(txt_CPrice.Text), 2).ToString();
            Console.Beep();
        ...
        private void btn_Add_Click(object sender, EventArgs e)
        {
            ...
            txt_CPrice.Text = (txt_CPrice.Text.Trim() == "" | txt_CPrice.Text.Trim() == ".") ? "0" : txt_CPrice.Text.Trim();
            ...
            else
            {
                ...
                dgv.Rows[rowindex].Cells["CPrice"].Value = txt_CPrice.Text;
                dgv.Rows[rowindex].Cells["Total"].Value = Math.Round(Convert.ToDecimal(txt_Quan.Text) * Convert.ToDecimal(txt_CPrice.Text), 2).ToString();
