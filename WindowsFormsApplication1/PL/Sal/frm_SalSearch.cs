...
{
    public partial class frm_SalSearch : Form
    {
        #region Declaration
        public DataTable dt;
        public string txt;
        ...
        private void txt_Search_TextChanged(object sender, EventArgs e)
        {
            ...
            dt.DefaultView.RowFilter = string.Format(dgv.Columns[1].DataPropertyName.ToString() + " Like '%" + txt_Search.Text + "%' OR " + dgv.Columns[2].DataPropertyName.ToString() + " Like '%" + txt_Search.Text + "%'");
        ...
        private void btn_OK_Click(object sender, EventArgs e)
        {
            ...
            com.Tag = dgv.SelectedRows[0].Cells[1].Value.ToString();
            txt_Search.Text = "Search";
            Hide();
        }
        #endregion
