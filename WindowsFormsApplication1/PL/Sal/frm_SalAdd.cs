...
{
    public partial class frm_SalAdd : Form
    {
        #region Declarations
        PL.Sal.frm_SalSearch search = new PL.Sal.frm_SalSearch();
        ...
        public void AddRow()
        {
            ...
            dgv.CurrentRow.Cells["No"].Value = com_Item_Name.Tag.ToString();
        ...
        {
            search.Text = "بحث عن منتج";
            search.com = com_Item_Name;

            search.dt = dt_Items;

            search.dgv.Columns[0].DataPropertyName = "ID";
            search.dgv.Columns[1].DataPropertyName = "NO";
            search.dgv.Columns[2].DataPropertyName = "Name";

            search.dgv.AutoGenerateColumns = false;
            search.dgv.DataSource = search.dt;
            search.ShowDialog();

            com_Item_Name.SelectedValue = search.txt;
        }
        ...
        private void btn_Add_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                dgv.Rows[rowindex].Cells["ID"].Value = com_Item_Name.Tag.ToString();
